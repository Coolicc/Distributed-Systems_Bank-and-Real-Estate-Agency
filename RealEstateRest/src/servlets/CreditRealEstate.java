...
/**
 * Servlet implementation class CreditRealEstate
 */
@WebServlet("/creditRealEstateServlet")
public class CreditRealEstate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreditRealEstate() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher requestDispatcher = request.getRequestDispatcher("../../creditRealEstate.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		URL url = new URL("http://localhost:8080/RealEstateRest/rest/services/buyRealEstateCredit");
		...
		if (ok) {
			...
			request.setAttribute("errorP", "Unable to buy real estate. Please check that"
					+ " your credit capability with your bank.");
		}
		RequestDispatcher requestDispatcher = request.getRequestDispatcher("../../creditRealEstate.jsp");
		requestDispatcher.forward(request, response);
	}
