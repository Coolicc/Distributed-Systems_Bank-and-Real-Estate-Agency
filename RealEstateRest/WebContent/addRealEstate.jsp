	...
	<section class="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" enctype="multipart/form-data" action="/RealEstateRest/addRealEstateServlet">
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bankAccount" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Picture</label>
                        ...
                        <div class="form-group">
                            <input type="submit" value="Add" name="submit" class="btn btn-primary btn-lg" required="required">
                        </div>
                     </div>
                </form> 
            </div><!--/.row-->
