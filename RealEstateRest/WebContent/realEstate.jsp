...
<body>
	...
	<table style="color: #000;">
		<tr>
			<td rowspan="10"><img height="400" width="400" src="/RealEstateRest/img/${realEstate.realEstateID}.jpg"/></td>
			<td colspan="10">
		...
		<tr>
			<th style="padding-left: 15px; width: 150px;">Description:</th>
			<td style="padding-right: 300px; padding-left: 15px;">${realEstate.description }</td>
		</tr>
		<tr>
			<th style="padding-left: 15px;">Price:</th>
			<td style="padding-right: 300px; padding-left: 15px;">${realEstate.price } $</td>
		</tr>
		<tr>
			<th style="padding-left: 15px;">Address:</th>
			<td style="padding-right: 300px; padding-left: 15px;">${realEstate.address }</td>
		</tr>
		<tr>
			<th style="padding-left: 15px;">City:</th>
			<td style="padding-right: 300px; padding-left: 15px;">${realEstate.city }</td>
		</tr>
		<tr>
			<th style="padding-left: 15px;">Seller:</th>
			<td style="padding-right: 300px; padding-left: 15px;"><a href="/RealEstateRest/userServlet?userID=${realEstate.seller }">${seller }</a></td>
		</tr>
		<c:if test="${realEstate.sold }">
			<tr>
				<th style="padding-left: 15px;">Sold</th>
			</tr>
			<tr>
				<th style="padding-left: 15px;">Buyer:</th>
				<td style="padding-right: 300px; padding-left: 15px;"><a href="/RealEstateRest/userServlet?userID=${realEstate.buyer }">${buyer }</a></td>
			</tr>
		</c:if>
	</table>
	<c:if test="${!empty user && !realEstate.sold}">
		<a href="/RealEstateRest/buyRealEstateServlet?realEstateID=${realEstate.realEstateID }"><button class="btn btn-primary btn-lg">Buy</button></a>
	</c:if>
	<c:if test="${!empty user && !realEstate.sold}">
		<a href="/RealEstateRest/creditRealEstateServlet?realEstateID=${realEstate.realEstateID }"><button class="btn btn-primary btn-lg">Buy with credit</button></a>
	</c:if>
</div>
