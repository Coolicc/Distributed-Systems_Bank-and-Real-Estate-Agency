	...
	<section class="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="/RealEstateRest/buyRealEstateServlet">
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Buy" name="submit" class="btn btn-primary btn-lg" required="required">
                        </div>
                     </div>
                </form> 
            </div><!--/.row-->
