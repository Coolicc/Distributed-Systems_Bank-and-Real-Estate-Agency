...
public class WSInInterceptor extends WSS4JInInterceptor {
	...
	public WSInInterceptor() {
		...
		getProperties().put(WSHandlerConstants.DEC_PROP_FILE, "resources/bankServerKeystore.properties");
		...
		getProperties().put(WSHandlerConstants.SIG_PROP_FILE, "resources/bankServerKeystore.properties");
	}
